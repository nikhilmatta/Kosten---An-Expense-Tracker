...
ImageButton addClothesExpenseButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.clothesExpensesRecyclerView);

        recyclerView.setHasFixedSize(true);

        recyclerView.setLayoutManager(new LinearLayoutManager(clothesExpense.this));

        progressDialog = new ProgressDialog(clothesExpense.this);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("users").child(uID).child("personalExpenses").child("Clothes");
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                adapter = new recyclerViewAdapter(clothesExpense.this, list);
